...
class ModelsTESTS(TestCase):
    def test_manufacturer_str(self):
        test_manufacturer = Manufacturer.objects.create(name="test", country="Test")
    ...
    def test_create_driver_with_licence(self):
        test_driver = get_user_model().objects.create_user(username="test",
                                                           password="test1234",
                                                           first_name="test",
                                                           last_name="test",
                                                           license_number="test",)
    ...
    def test_car_str(self):
        test_manufacturer = Manufacturer.objects.create(name="test", country="Test")
        test_car = Car.objects.create(model="test", manufacturer=test_manufacturer)
