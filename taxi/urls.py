...
urlpatterns = [
    ...
    path("manufacturers/search/", views.ManufacturerSearchView.as_view(), name="manufacturer-search"),
    ...
    path("drivers/search/", views.DriverSearchView.as_view(), name="driver-search"),
]
