...
class ManufacturerModelTestCase(TestCase):
    ...
    def test_unique_name(self):
        duplicate_manufacturer = Manufacturer(name='Test Manufacturer', country='Another Country')
...
class DriverModelTest(TestCase):
    ...
    def setUpTestData(cls):
        cls.driver = Driver.objects.create(username='testuser', first_name='Test', last_name='User')
...
class CarModelTest(TestCase):
    @classmethod
    def setUpTestData(cls):
        cls.manufacturer = Manufacturer.objects.create(name='Test Manufacturer', country='Test Country')
        cls.driver = Driver.objects.create(username='testuser', first_name='Test', last_name='User')
        cls.car = Car.objects.create(model='Test Car', manufacturer=cls.manufacturer)
