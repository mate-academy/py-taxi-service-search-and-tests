...
class AdminSiteTests(TestCase):
    ...
    def test_driver_lisence_listed(self):
        """
        Test that driver lisence is listed on page.
        """
    ...
    def test_car_model_manufacturer_listed(self):
        """
        Test that car model and manufacturer are listed on page.
        """
    ...
    def test_manufacturer_name_country_listed(self):
        """
        Test that manufacturer name and country are listed on page.
        """
    ...
    def test_driver_detail_license_listed(self):
        """
        Test that driver detail page contains license number.
        """
