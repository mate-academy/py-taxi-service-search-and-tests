...
class PrivateDriverFormatTests(TestCase):
    ...
    def test_if_search_name_is_admin_user(self):
        response = self.client.get(
            DRIVER_FORMATS_URL + "?username=admin.user1"
        )
    ...
    def test_create_driver_success_url_is_with_redict_to_list(self):
        ...
        self.client.post(DRIVER_CREATE_URL, data=data_form)
        ...
        self.assertEquals(new_user.license_number, data_form["license_number"])
