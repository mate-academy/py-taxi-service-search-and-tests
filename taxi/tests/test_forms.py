...
class FormsTest(TestCase):
    ...
    def test_check_license_validation(self):
        form_7_characters = DriverLicenseUpdateForm(data={"license_number": "ASD1231"})
        form_just_digits = DriverLicenseUpdateForm(data={"license_number": "12312312"})
        form_just_letters = DriverLicenseUpdateForm(data={"license_number": "AARDVARK"})
