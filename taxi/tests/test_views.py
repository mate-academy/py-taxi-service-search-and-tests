...
class PrivateManufacturerTests(TestCase):
    ...
    def test_search_manufacturer_by_name(self):
        ...
        manufacturer_for_search = Manufacturer.objects.filter(
            name__icontains=name_for_search
        )
        self.assertQuerysetEqual(
            response.context["manufacturer_list"],
            manufacturer_for_search
        )
...
class PrivateCarTests(TestCase):
    ...
    def test_search_car_by_model(self):
        ...
        car_for_search = Car.objects.filter(
            model__icontains=model_for_search
        )
        self.assertQuerysetEqual(
...
class PrivateDriverTests(TestCase):
    ...
    def test_search_driver_by_username(self):
        ...
        driver_for_search = Driver.objects.filter(
            username__icontains=username_for_search
        )
        self.assertQuerysetEqual(
