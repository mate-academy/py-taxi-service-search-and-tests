...
URL_LIST = [
    ...
    {
        "manufacturer_update_view_url":
            reverse("taxi:manufacturer-update", args=[1])
    },
    {
        "manufacturer_delete_view_url":
    ...
    {
        "driver_update_license_view_url":
        ...
        for view in URL_LIST:
            for name, path in view.items():
                ...
                self.assertNotEqual(
                    ...
                    200,
                    f"Access to this {name} view "
                    f"is denied for logged out users"
                )
        ...
        for view in URL_LIST:
            for name, path in view.items():
                ...
                self.assertEqual(
                    ...
                    200,
                    f"Access to this {name} view "
                    f"is should not denied for logged in users"
                )
